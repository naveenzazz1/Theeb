...
open class FPNTextField: UITextField {
	...
	private func setupLeftView() {
		...
		NSLayoutConstraint(item: phoneCodeTextField, attribute: .leading, relatedBy: .equal, toItem: flagButton, attribute: .trailing, multiplier: 1, constant: -2).isActive = true
